...
docker compose -f docker-compose.yml -f docker-compose.override.yml up -d --build backend frontend postgres redis celery-worker celery-beat prometheus grafana
Exit-IfFailed "Compose up -d --build (without nginx)"
